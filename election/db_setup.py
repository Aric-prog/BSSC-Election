...
tempC = Candidate(candidate_name= 'Ivano Ekasetia Dhojopatmo', candidate_vision='memajukan bssc', candidate_mission='meningkatkan kemampuan setiap anggota bssc', candidate_blueprint='sldkasd.com', candidate_video='lasdasd.com')
db.session.add(tempC)
tempC2 = Candidate(candidate_name= 'Francis Alexander', candidate_vision='memajukan bssc', candidate_mission='meningkatkan kemampuan setiap anggota bssc', candidate_blueprint='sldkasd.com', candidate_video='lasdasd.com')
db.session.add(tempC2)
tempC3 = Candidate(candidate_name= 'Kevin Wijaya', candidate_vision='memajukan bssc', candidate_mission='meningkatkan kemampuan setiap anggota bssc', candidate_blueprint='sldkasd.com', candidate_video='lasdasd.com')
