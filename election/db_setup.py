...
tempC = Candidate(candidate_name= 'Ivano Ekasetia', candidate_vision='memajukan bssc', candidate_mission='meningkatkan kemampuan setiap anggota bssc', candidate_blueprint='https://www.youtube.com/watch?v=MJbE3uWN9vE', candidate_video='https://www.youtube.com/watch?v=MJbE3uWN9vE')
db.session.add(tempC)
tempC2 = Candidate(candidate_name= 'Francis Alexander', candidate_vision='memajukan bssc', candidate_mission='meningkatkan kemampuan setiap anggota bssc', candidate_blueprint='https://www.youtube.com/watch?v=MJbE3uWN9vE', candidate_video='https://www.youtube.com/watch?v=MJbE3uWN9vE')
db.session.add(tempC2)
tempC3 = Candidate(candidate_name= 'Kevin Wijaya', candidate_vision='memajukan bssc', candidate_mission='meningkatkan kemampuan setiap anggota bssc', candidate_blueprint='https://www.youtube.com/watch?v=MJbE3uWN9vE', candidate_video='https://www.youtube.com/watch?v=MJbE3uWN9vE')
